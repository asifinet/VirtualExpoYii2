...
class ExpoCompanySearch extends ExpoCompany
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['username', 'company_name', 'company_sname', 'company_rep_name', 'address', 'city', 'state', 'country', 'zip_postal', 'mobile_phone', 'office_phone', 'fax', 'primary_email', 'secondary_email', 'company_logo', 'mkt_doc_dir', 'created_datetime', 'remember_token'], 'safe'],
        ];
    }
