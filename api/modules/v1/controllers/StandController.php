...
class StandController extends ActiveController
{
    public $modelClass = 'api\modules\v1\models\Stand';
    ...
    public function indexDataProvider() {
        ...
        $searchByAttr['StandSearch'] = $search;
        $searchModel = new \api\modules\v1\models\StandSearch();    
