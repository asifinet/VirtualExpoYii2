...
use api\modules\v1\models\MktdocsSearch;
use yii\rest\ActiveController;
use yii\helpers\ArrayHelper;
use yii\web\BadRequestHttpException;

class MktdocsController extends ActiveController
{
    public $modelClass = 'api\modules\v1\models\mktdocs';
    ...
    public function indexDataProvider() {
        ...
        $searchByAttr['MktdocsSearch'] = $search;
        $searchModel = new \api\modules\v1\models\MktdocsSearch();    
