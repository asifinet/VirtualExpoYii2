...
class Company extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['username', 'company_name', 'company_sname', 'company_rep_name', 'address', 'city', 'state', 'country', 'zip_postal', 'office_phone', 'primary_email', 'company_logo', 'mkt_doc_dir', 'remember_token'], 'required'],
            ...
            [['city', 'state', 'country', 'company_logo'], 'string', 'max' => 500],
